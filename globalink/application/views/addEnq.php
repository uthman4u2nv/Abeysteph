...
if(!empty($_SESSION['enq'])){
	...
	<input type="hidden" name="enqNo" value="<?php echo $_SESSION['enqNo']; ?>" /></td>
	</tr>
	<tr><td>Processed By</td><td>
	...
	<tr><td colspan="2"><input type="submit" value="Process Enquiry" class="btn btn-success" /></td></tr>
