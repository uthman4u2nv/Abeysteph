...
<div class="tab-content">
						...
						<input type="number" name="s1" step="any" class="form-control" required />
						<input type="number" name="s2" step="any" class="form-control" required />
						</div>
						<?php }elseif($_SESSION['dept']=="4"){ ?>
						<div class="input-group" style="margin-bottom:10px !important">
						<span class="input-group-addon">Quantity</span>
						<input type="number" name="qty" class="form-control" required />
						</div>
						<?php }elseif($_SESSION['dept']=="3"){ ?>
						<div class="input-group" style="margin-bottom:10px !important">
						<span class="input-group-addon">Quantity</span>
						<input type="number" name="qty" class="form-control" required />
						</div>
						...
						<input type="number" name="totalCost" step="any" class="form-control" required />
						</div>
						<?php } ?>
						<?php }else{?>
						<div class="input-group" style="margin-bottom:10px !important">
						...
						<?php }elseif($_SESSION['dept']=="1" || $_SESSION['dept']=="5" ){?>
						<div class="input-group" style="margin-bottom:10px !important">
						<span class="input-group-addon">Quantity</span>
						<input type="number" name="qty" class="form-control" required />
						</div>
