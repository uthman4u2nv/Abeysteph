<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  ...
		  <div id="mydiv" style='margin-top:0px !important; font-size:10px !important;'>
		   ...
		   <?php } ?>
		  <?php echo form_open('welcome/searchTransBF2'); ?>
		  <div class="col-sm-4">
		  ...
		  if(empty($trans)){
			  ...
			  <tr><td>#</td><td>Date</td><td>Name</td><td>Dept</td><td>Order #</td><td>Raised By</td><td>Date/Time Raised</td><td>Total Amount</td><td>Discount Approved</td><td>Advance</td><td>Balance</td><!--<td>Cashier</td>--></tr>
			  <?php
			  $sno=0;
			  $totalAmount=0;
			  $totalAdvance=0;
			  ...
			  foreach($trans as $row){
				  ...
				  <td><?php echo anchor('welcome/cleardiscount/'.$row['order_no'],'Clear Discount'); ?></td>
				  </tr>
				  <?php
			  }
			  ?>
