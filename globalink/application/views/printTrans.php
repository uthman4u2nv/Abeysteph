...
foreach($trans22 as $t){}
   ?>
            <table width="80%" id="content22" class="table table-striped" border='0' style="margin-top:0px !important; font-size:11px !important;">
				...
				<tr><td><strong>Staff</strong></td><td colspan='3'><strong><?php echo $g; ?></strong></td></tr>
				</table>

          
				<table width="80%" id="content23" class="table" style="margin-top:0px !important; font-size:11px !important;">
                <tr><td>#</td><td><strong>Description</strong></td><td><strong>Qty</strong></td><!--<td><strong>Size</strong></td>--><td><strong>N</strong></td></tr>
    ...
    <!--<tr><td>1.</td><td align="left"><?php echo $t['description'];?></td><td><?php echo $t['qty']; ?></td><td align="left"><?php echo number_format($t['total_amount'],2);?></td></tr>-->
	   ...
	   foreach($trans as $r){
		   ...
		   <tr><td><?php echo $sno; ?></td><td><p><?php echo strtoupper(returnJobName($products,$r['job_type']));?></p><p><?php echo $r['description']; ?></p></td><td><?php echo $r['qty']; ?></td><!--<td><?php echo $r['s1']."X".$r['s2'];?></td>--><td><?php echo number_format($r['total_amount'],2); ?></td></tr>
	   <?php } ?>
	   <?php
    ?>
	 <tr><td></td><td></td><td><strong>Total</strong></td><td><strong><?php echo number_format($tot,2); ?></strong></td></tr>
        ...
        <h6 style="margin-top:0px !important; font-size:10px !important;"><b>DISCLAIMER:</b>The Company does not make refund for money paid. Kindly ensure you cross check and sign on the sample before we proceed with the job.</h6>
	...
	<a class="list-group-item active"><strong>DESIGNERS COPY: <strong><?php echo $numb; ?></strong></strong></a>
	<center>
            <table id="header" style="margin-top:0px !important; font-size:11px !important;">
                <!--<tr><td colspan="2" align="center"><?php 
            //echo img('images/log.png');
   ...
   ?>
    ...
    <!--<tr><td>1.</td><td align="left" wrap="yes"><?php echo $t['description'];?></td><td><?php echo $t['qty']; ?></td><td align="left"><?php echo number_format($t['total_amount'],2);?></td></tr>-->
	   ...
	   foreach($trans as $rr){
		   ...
		   <tr><td><?php echo $sno; ?></td><td><p><?php echo strtoupper(returnJobName($products,$rr['job_type']));?></p><p><?php echo $rr['description']; ?></p></td><td><?php echo $rr['qty']; ?></td><!--<td><?php echo $rr['s1']."X".$rr['s2'];?></td>--><td><?php echo number_format($rr['total_amount'],2); ?></td></tr>
	   <?php } ?>
	   <?php
    ?>
	 <tr><td></td><td></td><td><strong>Total</strong></td><td><strong><?php echo number_format($tot,2); ?></strong></td></tr>
...
foreach($trans22 as $t){}
   ?>
	...
	<a class="list-group-item active"><strong>JOB ORDER: <strong><?php echo $numb; ?></strong></strong></a>
	<center>
            <table id="header" style="margin-top:0px !important; font-size:11px !important;">
                <!--<tr><td colspan="2" align="center"><?php 
            //echo img('images/log.png');
...
<!-- End Other depts Printing -->
	...
	<?php 
	function returnJobName($products,$id){
		$name="";
