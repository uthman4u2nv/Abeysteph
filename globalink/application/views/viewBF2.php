<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  ...
		  if(empty($trans)){
			  ...
			  <tr><td>#</td><td>Date</td><td>Name</td><td>Dept</td><td>Job Type</td><td>Order #</td><td>Raised By</td><td>Date/Time Raised</td><td>Total Amount</td><td>Advance</td><td>Balance</td><!--<td>Cashier</td>--></tr>
			  <?php
			  $sno=0;
			  $totalAmount=0;
			  $totalAdvance=0;
