<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  ...
		  if(!empty($cashierName)){
			  ?>
			  <li class="list-group-item"><STRONG><?php echo strtoupper($cashierName); ?></STRONG></li>
			  <?php
		  }
		  ?>
		  <?php
		  if(!empty($operatorName)){
			  ?>
			  <li class="list-group-item"><STRONG><?php echo strtoupper($operatorName); ?></STRONG></li>
			  <?php
		  }
		  ?>
		   <?php
		  ...
		  if(empty($trans)){
			  ...
			  foreach($trans as $row){
				  ...
				  <td><?php echo anchor_popup('welcome/printTrans/'.$row['order_no'],'Print',array('height'=>400,'width'=>400,'class'=>'btn btn-default btn-primary')); ?></td>
				  </tr>
				  <?php
		  ...
		  <table class="table table-striped table-bordered">
		  <tr><td>Total Sales</td><td>POS</td><td>Transfer</td><td>Cheque</td></tr>
		  <tr><td><?php echo number_format($a1=loadOtherOfficeSales($loadOtherOfficeSales,$office=2,$method=4)+loadOtherOfficeSales($loadOtherOfficeSales,$office=2,$method=3)+loadOtherOfficeSales($loadOtherOfficeSales,$office=2,$method=2),2); ?></td><td><?php echo number_format(loadOtherOfficeSales($loadOtherOfficeSales,$office=2,$method=3)); ?></td><td><?php echo number_format(loadOtherOfficeSales($loadOtherOfficeSales,$office=2,$method=4)); ?><td><?php echo number_format(loadOtherOfficeSales($loadOtherOfficeSales,$office=2,$method=2)); ?></td></tr>
		  ...
		  <table class="table table-striped table-bordered">
		  <tr><td>Total Sales</td><td>POS</td><td>Transfer</td><td>Cheque</td></tr>
		  <tr><td><?php echo number_format($agl=loadOtherOfficeSales($loadOtherOfficeSales,$office=3,$method=4)+loadOtherOfficeSales($loadOtherOfficeSales,$office=3,$method=3)+loadOtherOfficeSales($loadOtherOfficeSales,$office=3,$method=2),2); ?></td><td><?php echo number_format(loadOtherOfficeSales($loadOtherOfficeSales,$office=3,$method=3)); ?></td><td><?php echo number_format(loadOtherOfficeSales($loadOtherOfficeSales,$office=3,$method=4)); ?><td><?php echo number_format(loadOtherOfficeSales($loadOtherOfficeSales,$office=3,$method=2)); ?></td></tr>
