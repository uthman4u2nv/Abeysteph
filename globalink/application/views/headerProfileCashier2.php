                               ...
                               <!-- <li class="user-body">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <?php echo anchor('welcome/logout','Sign Out',array('class'=>'btn btn-default btn-flat')); ?>
