...
<div class="tab-content">
						...
						<select name="designer" required class="form-control">
						...
						<div class="panel panel-heading"><strong>Search Result</strong></div>
						<div class="panel panel-body">
						<strong><h3>Search From:<?php echo $from; ?> To:<?php echo $to; ?></h3></strong>
						<hr />
