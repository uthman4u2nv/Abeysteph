          ...
          <?php }
           ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                    <div class="panel panel-heading"><strong>Expenses From: <?php echo $from; ?> To: <?php echo $to; ?></strong></div>
                    <div class="panel panel-body">
                    <?php
                    if(!empty($expenses)){ ?>
					<div id="mydiv">
                    <table class="table table-striped">
                        <tr><td>S/No</td><td>Job Order No</td><td>Expenses</td><td>N</td></tr>
                        <?php
                        $sno=0;
                        $total=0;
                        ...
                        $total+=$e['expensesAmt'];
                                ?>
                        <tr><td><?php echo $sno; ?></td><td><?php echo $e['jobNo']; ?></td><td><?php echo $e['expenses']; ?></td><td><strong><?php echo number_format($e['expensesAmt'],2); ?></strong></td></tr>
                        <?php } ?>
