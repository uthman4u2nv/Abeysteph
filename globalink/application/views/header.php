...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- Static navbar -->
      <div class="navbar navbar-default" role="navigation" style="margin-bottom:0px !important; margin-top:-50px !important; background: #ffffff !important; border: 0px solid !important;">
      ...
      <?php
	  $img=array('src'=>'images/logo.png','class'=>'img-responsive');
      echo img($img)?>
      </div>
