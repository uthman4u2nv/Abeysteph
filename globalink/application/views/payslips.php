...
<!-- Schedule -->
	...
	<table class="table table-bordered table-striped">
		...
		foreach($depts as $d){
			?>
			<tr><td colspan="7"><strong><?php echo strtoupper($d['departmentName']);?></strong></td></tr>
		<tr><td>#</td><td>Staff Name</td><td>Bank</td><td>Account Name</td><td>Account No</td><td>Gross</td><td>Amount</td></tr>
	<?php
	$no=0;
	$sum=0;
foreach($staff as $row){
	if($d['departmentID']==$row['departmentID']){
	$no++;
	?>
	<tr>
	<td><?php echo $no; ?></td>
...
<?php }
?>
<!--<tr><td colspan="6" align="right"><strong>TOTAL</strong></td><td><strong><?php echo number_format($totAmt,2);?></strong></td></tr>-->
		<?php } ?>
