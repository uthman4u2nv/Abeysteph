<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="panel panel-default">
        ...
        <div class="panel panel-body">
            ...
            <li class="list-group-item"><?php echo anchor_popup('../sampleorg.csv','Click to Download the sample format',array('width'=>400,'height'=>600)); ?></li>
            ...
            <?php
            echo form_open_multipart('welcome/uploadOrg2');
            ?>
            <div class="input-group" style="margin-bottom: 10px !important">
                <span class="input-group-addon">Organisation List</span>
